...
vector<vector<int> > add_matrix(vector<vector<int> > matrix_A, vector<vector<int> > matrix_B, int split_index, int multiplier = 1){
	/***********************************************
     * Parametros:
     * vector<vector<int> > matrix_A: Primera matriz.
     * vector<vector<int> > matrix_B: Segunda matriz.
     * int split_index: La mitad de la cantidad de columnas de la primera matriz.
     * int multiplier: Define si sumara o restará la matriz.
     * *********************************************
     * Descripción:
	 * Suma o resta la segunda matriz a la primera matriz y retorna el resultado de esta.
    ***********************************************/
...
vector<vector<int> > multiply_matrix(vector<vector<int> > matrix_A, vector<vector<int> > matrix_B){
	/***********************************************
     * Parametros:
     * vector<vector<int> > matrix_A: Primera matriz a multiplicar.
     * vector<vector<int> > matrix_B: Segunda matriz a multiplicar.
     * *********************************************
     * Descripción:
	 * Realiza las operaciones de Strassen que se muestan en el informe,
	 * y llama recursivamente esta función en base a eso, haciendo
	 * siete llamadas recursivas para poder multiplicar.
    ***********************************************/
